...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (name == GradeBookType.Standard.ToString())
            {
                gradeBook = new StandardGradeBook(name);


               }
            else if (name == GradeBookType.Ranked.ToString())
            {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' - Creates a new gradebook where 'Name' is the name of the gradebook and " +
